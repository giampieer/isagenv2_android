...
public class Fragment_Listar_Proyecto extends Fragment implements View.OnClickListener {
    ...
    String conexion="";
    public Fragment_Listar_Proyecto() {
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        View obj=inflater.inflate(R.layout.fragment_lista_proyecto, container, false);
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Proyectos");
        fab = (FloatingActionButton) obj.findViewById(R.id.fab_proyecto);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FragmentManager fragmentManager = getFragmentManager();
                Fragment_Grabar_Proyecto container1Fragment = new Fragment_Grabar_Proyecto();
                ...
                fragmentManager.beginTransaction()
                        ...
                        .addToBackStack(null)
                        .addSharedElement(fab,"transicion_imagen_proyecto")
                        .commit();
            }
        });
    ...
    class Async_Listar_Proyectos extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... obj) {
            ...
            adapter=new CardView_Adapter_Proyecto(listado,getActivity());}
            return mensaje;
        }
